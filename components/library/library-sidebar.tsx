...
const topics = [
  ...
  { id: "dawah", name: "Dawah", count: 43 },
]

const scholars = [
  { id: "ibn-taymiyyah", name: "Ibn Taymiyyah", count: 45 },
  { id: "imam-nawawi", name: "Imam An-Nawawi", count: 38 },
  { id: "imam-ghazali", name: "Imam Al-Ghazali", count: 32 },
  ...
  { id: "safiur-rahman", name: "Safiur-Rahman Al-Mubarakpuri", count: 12 },
  { id: "hamza-tzortzis", name: "Hamza Andreas Tzortzis", count: 8 },
]
