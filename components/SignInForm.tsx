  ...
  return (
    <CardContent className="space-y-6 px-8 pb-8">
      <div className="space-y-2">
        <Label htmlFor="email" className="text-islamic-green text-sm font-medium">
          Email Address
        </Label>
      ...
      <div className="space-y-2">
        <Label htmlFor="password" className="text-islamic-green text-sm font-medium">
          Password
        </Label>
        <div className="relative">
      ...
      <div className="flex justify-end">
        <button className="text-sm text-muted-green hover:text-green-600 transition-colors">
          Forgot password?
        </button>
      </div>
